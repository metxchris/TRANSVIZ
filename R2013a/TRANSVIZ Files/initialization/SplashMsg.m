...
htmlStr = [ ...
    ...
    '<br><br>' ...
    'The source code of this version of TRANSVIZ was written using Matlab version R2013a, and is not compatible with Matlab version R2014b or anything newer.'...
    '</div>' ...
    sectionStart,'Matlab Version Differences',sectionEnd ...
    verStart,'R2014b',verEnd...
    tableStart...
    trStart,'Matlab version R2014b introduced an updated graphics engine:  Figures (especially several line options) and text look much better as compared to the R2013a version.  Legends have a semi-transparent background; a line-transparency option was added.',trEnd...
    trStart,'Figures and exported .eps files are less glitchy.',trEnd...
    trStart,'The compiled executable comes with a loading splash screen, and will prompt the user to download the appropriate Matlab compiler runtime (MCR) if needed.',trEnd...
    ...
    trStart,'The compiled executable has no loading splash screen; the user must wait upwards of a minute with no feedback while the MCR is loaded.',trEnd...
