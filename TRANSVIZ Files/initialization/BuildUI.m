...
ui.main.textHeaderH(3) = uicontrol(...
    ...
    'enable', 'off', ...
    'FontWeight', 'bold');
% % Still experimenting with where to put this
% ui.main.textHeaderH(4) = uicontrol(...
%     'Style', 'text', ...
%     'String', 'Plot Tools:', ...
%     'Units', 'Pixels', ...
%     'HorizontalAlignment', 'left', ...
%     'enable', 'off', ...
%     'FontWeight', 'bold');
% ui.main.plotToolsH = uibuttongroup(...
%     'visible', 'on', ...
%     'units', 'pixels', ...
%     'bordertype', 'none', ...
%     'SelectedObject', []);
% cData = load('icons\icon_Pan.mat');
% ui.main.plotToolsB(1) = uicontrol( ...
%     'style', 'togglebutton', ...
%     'CData', cData.cdata,...
%     'units', 'pixels', ...
%     'string', '', ...
%     'parent', ui.main.plotToolsH, ...
%     'val', 0, ...
%     'enable', 'on');
% cData = load('icons\icon_ZoomIn.mat');
% ui.main.plotToolsB(2) = uicontrol( ...
%     'style', 'togglebutton', ...
%     'CData', cData.cdata,...
%     'units', 'pixels', ...
%     'string', '', ...
...
ui.menu.legendLocationH(4) = uimenu(ui.menu.legendLocationMH, ...
    'Label', '&SouthWest');
ui.menu.lineTransparencyMH = uimenu(ui.menu.editMH, ...
    'Label', 'Line &Transparency');
ui.menu.lineTransparencyH(1) = uimenu(ui.menu.lineTransparencyMH, ...
    'Label', '&1.00');
ui.menu.lineTransparencyH(2) = uimenu(ui.menu.lineTransparencyMH, ...
    'Label', '0.9&5');
ui.menu.lineTransparencyH(3) = uimenu(ui.menu.lineTransparencyMH, ...
    'Label', '0.&90');
ui.menu.lineTransparencyH(4) = uimenu(ui.menu.lineTransparencyMH, ...
    'Label', '0.&80');
ui.menu.lineTransparencyH(5) = uimenu(ui.menu.lineTransparencyMH, ...
    'Label', '0.&60');
ui.menu.lineTransparencyH(6) = uimenu(ui.menu.lineTransparencyMH, ...
    'Label', '0.&40');
ui.menu.lineTransparencyH(7) = uimenu(ui.menu.lineTransparencyMH, ...
    'Label', '0.&20');
