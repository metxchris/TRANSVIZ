...
htmlStr = [ ...
    ...
    '<br><br>' ...
    'The source code of TRANSVIZ was written using Matlab version R2013a, and is not compatible with Matlab versions R2014b+. '...
    'No more major updates planned; this code should be rewritten in Python to secure forward compatibility.'...
    '</div>' ...
