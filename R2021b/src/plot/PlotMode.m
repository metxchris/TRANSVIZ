...
source = get(handle);
option.plotMode = strrep(source.Text, '&', '');
...
switch option.plotMode
    case 'Line Plot'
        ...
        set(lineMenuHandles, 'enable', 'on');
        set(surfMenuHandles, 'enable', 'off');
    case 'Surface Plot'
        ...
        set(lineMenuHandles, 'enable', 'off');
        set(surfMenuHandles, 'enable', 'on');
